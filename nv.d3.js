            ...
            nv.dom.read(function () {
              ...
              if (svgComp) {
                ...
                if (svgBoundTop < 0) {
                  ...
                  svgBoundTop =
                    Math.abs(svgBoundTop) > containerBound.height
                      ? 0
                      : svgBoundTop;
                }
...
*/
  nv.utils.calcApproxTextWidth = function (svgTextElem) {
    if (
      typeof svgTextElem.style === "function" &&
        ...
        switch (axis.orient()) {
          ...
          case "right":
            ...
            axisLabel
              ...
              .attr(
                "y",
                rotateYLabel ? -Math.max(margin.right, width) + 12 : -10
      ...
      selection.each(function (data) {
        ...
        if (!yDomain) {
          ...
          var yMin = d3.min(
            data.map(function (d) {
              ...
              if (
                d.values.hasOwnProperty("whisker_low") &&
                d.values.whisker_low !== null
              ) {
                min_arr.push(d.values.whisker_low);
              }
              if (
                d.values.hasOwnProperty("outliers") &&
                d.values.outliers !== null
              ) {
          ...
          var yMax = d3.max(
            data.map(function (d) {
              ...
              if (
                d.values.hasOwnProperty("whisker_high") &&
                d.values.whisker_high !== null
              ) {
        ...
        boxplots
          ...
          .attr("transform", function (d, i, j) {
            return (
              "translate(" + (x(getX(d, i)) + x.rangeBand() * 0.05) + ", 0)"
            );
          })
        ...
        boxEnter.each(function (d, i) {
          ...
          ["low", "high"].forEach(function (key) {
            if (
              d.values.hasOwnProperty("whisker_" + key) &&
              d.values["whisker_" + key] !== null
            ) {
              box
                .append("line")
        ...
        ["low", "high"].forEach(function (key) {
          ...
          boxplots
            ...
            .watchTransition(renderWatch, "nv-boxplot: boxplots")
            .attr("x1", x.rangeBand() * 0.45)
            .attr("y1", function (d, i) {
              return y(d.values["whisker_" + key]);
            })
            .attr("x2", x.rangeBand() * 0.45)
      ...
      selection.each(function (data) {
        ...
        if (
          ...
          !data.filter(function (d) {
            return (
              d.values.hasOwnProperty("Q1") &&
              d.values.hasOwnProperty("Q2") &&
              d.values.hasOwnProperty("Q3")
            );
          }).length
        ) {
    ...
    function chart(selection) {
      selection.each(function (d, i) {
        ...
        wrap
          ...
          .on("mouseover", function (d, i) {
            var label =
              rangeLabelz[i] || (!i ? "Maximum" : i == 1 ? "Mean" : "Minimum");
            dispatch.elementMouseover({
              value: d,
              label: label,
              color: d3.select(this).style("fill"),
    ...
    function chart(selection) {
      ...
      selection.each(function (data) {
        ...
        bars
          ...
          .attr("height", function (d, i) {
            return Math.max(
              Math.abs(y(getY(d, i)) - y((yDomain && yDomain[0]) || 0)) || 1
            );
          });
      ...
      selection.each(function (data) {
        ...
        function onBrush() {
          ...
          g.select(".nv-focus .nv-y2.nv-axis")
            .style(
              "opacity",
              dataLines.length && !dataLines[0].disabled ? 1 : 0
            )
  ...
  nv.models.lineWithFocusChart = function () {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        var availableWidth = nv.utils.availableWidth(width, container, margin),
          availableHeight1 =
            nv.utils.availableHeight(height, container, margin) - height2,
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        yScale1
          .domain(
            yDomain1 ||
              d3.extent(d3.merge(series1).concat(extraValue1), function (d) {
                return d.y;
              })
          )
        ...
        yScale2
          .domain(
            yDomain2 ||
              d3.extent(d3.merge(series2).concat(extraValue2), function (d) {
                return d.y;
              })
          )
          .range([0, availableHeight]);
  ...
  nv.models.parallelCoordinates = function () {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        dimensionsEnter
          .append("g")
          .attr("class", "nv-parallelCoordinates nv-axis");
        dimensionsEnter
          .append("g")
          .attr("class", "nv-parallelCoordinates-brush");
        dimensionsEnter
          .append("text")
          .attr("class", "nv-parallelCoordinates nv-label");
        ...
        dimensions.select(".nv-axis").each(function (d, i) {
          d3.select(this).call(
            axis.scale(y[d]).tickFormat(d3.format(dimensionFormats[i]))
          );
        });

        dimensions
          .select(".nv-parallelCoordinates-brush")
          .each(function (d) {
  ...
  nv.models.scatter = function () {
    ...
    chart._calls = new (function () {
      ...
      this.highlightPoint = function (seriesIndex, pointIndex, isHoverOver) {
        nv.dom.write(function () {
          container
            .select(" .nv-series-" + seriesIndex + " .nv-point-" + pointIndex)
            .classed("hover", isHoverOver);
        });
      };
    })();
